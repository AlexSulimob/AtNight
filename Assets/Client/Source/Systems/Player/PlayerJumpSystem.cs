    ...
    public class PlayerJumpSystem : IEcsRunSystem,IEcsInitSystem {        
        ...
        public void Run (EcsSystems systems) {
            ...
            foreach (var entity in filter)
            {
                ...
                // if(input.jump)
                if(_shared.Value.inputService.JUMP_INPUT_DOWN)
                {
                ...
                if(_shared.Value.inputService.JUMP_INPUT_REALEASE)
                {
                ...
                if (_shared.Value.inputService.JUMP_INPUT_REALEASE && rb.rb.velocity.y > 0f)
                {
